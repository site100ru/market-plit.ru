	...
	<div class="card">
		...
		<div class="card-body">
			...
			if ( $product->get_price_html() == null ) {
				...
				echo '<span class="'.esc_attr( apply_filters( 'woocommerce_product_price_class', 'price' ) ).'"><span style="font-family: HelveticaNeueCyr-Light; color: #323232; font-size: 18px;">'.$product_price.'</span></span>';
