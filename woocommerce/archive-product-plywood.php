				...
				<div class="row">
					<div class="col-md-3">
						<?php
							...
							echo '<span class="widget-title">Категории изделий из фанеры</span>';
							echo '<ul class="product-categories">'; ?>
							<li class="cat-item<?php if ( $current_cat_id == 329 ) { echo ' current-cat'; } ?>">
								<a href="https://stock-line.ru/product-category/изделия-из-фанеры/">Все изделия из фанеры</a>
								<?php
									// Считаем количество товаров в категории
									$term = get_term( 329, 'product_cat' );
							...
							$args = array(
								...
								'parent'   => 329 // ID категории подкатегории которой нужно получить
							);
